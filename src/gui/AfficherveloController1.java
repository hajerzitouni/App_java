 ...
 * @author Hajer
 */
public class AfficherveloController1 implements Initializable {
    ...
    private void afficherImage(MouseEvent event) {
      ...
      selectedid = (velo) table.getSelectionModel().getSelectedItem();
       Image i = new Image( "http://localhost//Application1/"+selectedid.getImage() );
...
//      bch thezzek lel interface lo5ra                
            ...
            Logger.getLogger(AfficherveloController1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void retour(ActionEvent event) {
     try {
  javafx.scene.Parent tableview = FXMLLoader.load(getClass().getResource("homev.fxml"));
            Scene sceneview = new Scene(tableview);
            Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
            window.setScene(sceneview);
            window.show();
